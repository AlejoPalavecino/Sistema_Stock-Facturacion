      ...
      <table className="w-full text-sm text-left text-slate-500">
        <thead className="text-xs text-slate-700 uppercase bg-slate-100">
          <tr>
            ...
            <th scope="col" className="px-6 py-3 text-right">Precio (ARS)</th>
            <th scope="col" className="px-6 py-3 text-center">Stock</th>
            <th scope="col" className="px-6 py-3 text-center">Mín.</th>
        ...
        <tbody>
          {products.map((product) => (
            <tr key={product.id} className="bg-white border-b hover:bg-slate-50">
              ...
              <td className="px-6 py-4 text-right">{formatARS(product.priceARS)}</td>
              <td className="px-6 py-4 text-center font-medium" aria-live="polite">{product.stock}</td>
