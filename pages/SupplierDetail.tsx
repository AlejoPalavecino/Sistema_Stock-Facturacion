...
export const SupplierDetail: React.FC = () => {
    const { supplierId } = rr.useParams<{ supplierId: string }>();
    ...
    const handleSavePurchase = async (purchaseData: Omit<Purchase, 'id' | 'createdAt' | 'supplierId' | 'status'>) => {
        await addPurchase(purchaseData);
        setPurchaseModalOpen(false);
    };
    
    const handleSavePayment = async (paymentData: Omit<SupplierPayment, 'id' | 'createdAt' | 'supplierId'>) => {
        ...
        <div className="bg-slate-50 min-h-screen">
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                <header className="mb-8">
                    <rr.Link to="/proveedores" className="inline-block mb-4">
