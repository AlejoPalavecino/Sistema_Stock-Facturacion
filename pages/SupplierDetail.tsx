            ...
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                <header className="mb-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 flex flex-col md:flex-row justify-between items-start">
                        <div>
                            <h1 className="text-3xl font-bold text-slate-900">{supplier.businessName}</h1>
                            <p className="text-base text-slate-700 mt-1">{supplier.docType}: {supplier.cuit}</p>
                            <p className="text-base text-slate-700">{supplier.email}</p>
                        </div>
                        <div className="text-left md:text-right mt-4 md:mt-0">
                            <p className="text-base text-slate-700">Deuda con Proveedor</p>
